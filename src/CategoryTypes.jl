...
function make_category_type_upload_request(url :: String, headers :: Vector{Pair{String, String}}, file_io :: Union{Dict{String, Union{IOStream, IOBuffer}}, HTTP.Form, Dict{String, String}, Dict{String, HTTP.Forms.Multipart}})
...
function upload_category_types(base_url :: String, project_id :: Integer, _csrf_token :: String, file_name :: Union{String, Vector{String}}, file_path :: Union{String, Vector{String}}="./", version :: String="v1")
    ...
    for file in files
        ...
        upload_dict = Dict(["file" => HTTP.Multipart(file_name, file_io)])
        @info "upload_dict:"
        @info upload_dict
